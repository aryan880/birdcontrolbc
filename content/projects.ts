...
export const galleryProjects: Project[] = [
  {
    ...
    summary: "Real job photography documenting balcony cleanup, preparation, support hardware, and a black bird-netting installation across an open balcony.", tags: ["Balcony netting", "Cleanup", "Residential"],
    ...
    gallery: [
      { src: "/media/projects/lower-mainland-balcony-netting/balcony-before-cleanup.webp", alt: "Balcony floor during the initial cleanup and preparation stage", caption: "The balcony during cleanup and preparation before the netting installation moved forward.", kind: "before" },
      { src: "/media/projects/lower-mainland-balcony-netting/installation-overview.webp", alt: "Black bird netting being fitted across a residential balcony opening", caption: "A wide installation-progress view showing the net, ceiling anchors, support poles, and surrounding balcony opening.", kind: "overview" },
      { src: "/media/projects/lower-mainland-balcony-netting/netting-wide-view.webp", alt: "Bird netting spanning the balcony opening with the Lower Mainland skyline beyond", caption: "The netting layout follows the full opening while preserving light and the outward view.", kind: "overview" },
    ...
    videos: [{ src: "/media/projects/lower-mainland-balcony-netting/netting-walkthrough.mp4", poster: "/media/projects/lower-mainland-balcony-netting/walkthrough-poster.webp", title: "Balcony netting walkthrough", caption: "A short on-site view of the netting across the balcony opening. The clip has been muted and compressed for the web." }],
    seo: { title: "Balcony Bird Netting Project | Lower Mainland BC", description: "See real balcony cleanup, preparation, and bird-netting installation photography from a recent Lower Mainland residential project." },
    hero: { eyebrow: "Recent project", title: "Balcony cleanup and bird-netting installation.", description: "A real residential job documenting the condition of the balcony, the preparation work, and the netting system across the opening." },
    ...
    results: ["The open side of the balcony was covered by a physical netting barrier", "The support and attachment details were fitted around the existing balcony geometry", "The job was documented with real progress photos and a short walkthrough"], relatedServiceSlugs: ["balcony-bird-netting", "pigeon-dropping-cleaning", "strata-bird-control"],
  },
  {
